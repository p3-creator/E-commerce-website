...
function Home() {
  return (
    <div>
      <section className="container pt-2 pt-md-5 pt-lg-5">
            ...
            <div className="col-lg-6 text-end">
             ...
             <div className="row my-1 mb-5 grey">
              ...
              >
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_apple.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/logo_samsung.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_hp.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_lenovo.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/brand_ugreen.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_asus.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_huawei.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                  ...
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_microsoft.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_vivo.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_tcl.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/brand_anker.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_logitech.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
                      src="https://m.media-amazon.com/images/G/40/Electronics/Store/kamja/L2/Electronics/Logo/brand_oppo.jpg"
                      alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img
        ...
        <div className="row">
          ...
          <div className="col-lg-9 ps-5">
            <div className="row">
              ...
              <div className="col-lg-2 wd overflow-hidden ms-1">
                <div className="box position-relative shadow">
                  <img className="w-100 hv px-2 py-2 pb-5 prod2" src={ `${process.env.PUBLIC_URL}/images/faber.jpg`} alt="" />
                  <div className="box-d position-absolute text-center">
              ...
              <div className="row pt-5">
                ...
                <div className="col-lg-2 wd overflow-hidden ps-3">
                  <div className="box position-relative shadow">
      ...
      <section className="mt-5">
        <div className="container-fluid grey py-4">
          <div className="row text-center py-4">
            ...
            <div className="col-lg-3">
              <img className="pb-3 prod1" src="https://png.pngtree.com/png-vector/20231211/ourmid/pngtree-payment-icon-income-png-image_10858293.png" alt="" />
              <h6>Safe Payment</h6>
            </div>
            <div className="col-lg-3">
              <img className="pb-3 prod1" src="https://static.vecteezy.com/system/resources/previews/012/255/042/non_2x/simple-easy-return-policy-icon-badge-sign-symbol-isolated-on-white-background-with-arrow-design-vector.jpg" alt="" />
              <h6>7 Days Return Policy</h6>
            </div>
            <div className="col-lg-3">
              <img className="pb-3 prod1" src="https://cdn-icons-png.freepik.com/512/10645/10645776.png" alt="" />
